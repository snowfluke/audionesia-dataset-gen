...
export const REJECT_LABELS = {
  ...
  parenthetical: "memuat tanda kurung yang tidak dibaca",
  ...
  "foreign-words": "memuat klausa bahasa asing",
  "foreign-spelling": "memuat kata dengan ejaan asing",
  "foreign-names": "memuat deretan nama asing",
  "latin-taxonomy": "memuat nama ilmiah Latin",
  "chemical-notation": "memuat rumus atau kode yang sulit dibaca",
