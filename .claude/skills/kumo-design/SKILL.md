...
Vendored from https://kumo-ui.com/skill.md on 2026-08-27. Cloudflare Kumo is MIT licensed (https://github.com/cloudflare/kumo). This app uses Kumo tokens and class strings inside hand-rolled SolidJS components; read `Button`, `Text`, `Dialog` in the examples as their Solid counterparts under `src/components/`.
